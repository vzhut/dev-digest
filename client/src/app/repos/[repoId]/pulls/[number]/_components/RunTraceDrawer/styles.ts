...
export const s = {
  ...
  promptTokens: { fontSize: 11.5, color: "var(--text-muted)" } satisfies CSSProperties,
  ...
  promptToggleLabel: { fontSize: 12, color: "var(--text-muted)" } satisfies CSSProperties,
  ...
  matchCount: { fontSize: 12, color: "var(--text-muted)", whiteSpace: "nowrap" } satisfies CSSProperties,
  modalScroll: { flex: 1, minHeight: 0, overflow: "auto" } satisfies CSSProperties,
  noMatches: { padding: "32px 24px", textAlign: "center", color: "var(--text-muted)", fontSize: 13 } satisfies CSSProperties,
  promptText: { margin: 0, padding: "16px 24px", whiteSpace: "pre-wrap", fontSize: 12.5, lineHeight: 1.6 } satisfies CSSProperties,
} as const;
