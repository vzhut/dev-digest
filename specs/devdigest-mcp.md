...
- **Open / unverified:** real duration of a review run vs the 120 s limit; `/context` share in a fresh chat; Claude Code behaviours listed under "Unverified" (auto-background at 120 s, progress notifications resetting timeouts); `get_blast_radius` implementation (homework; contract already fixed).
