...
| [onion-architecture](onion-architecture/SKILL.md) | Backend | Server layering: rings, dependency rule, where routes/services/repositories/adapters go, review checklist |
| [next-best-practices](next-best-practices/SKILL.md) | Frontend | Next.js App Router, RSC boundaries, data fetching, optimization |
| [react-best-practices](react-best-practices/SKILL.md) | Frontend | React anti-patterns, state management, hooks rules |
| [frontend-architecture](frontend-architecture/SKILL.md) | Frontend | Where client code lives: placement, component splitting, promotion, import boundaries (DevDigest `client/`) |
